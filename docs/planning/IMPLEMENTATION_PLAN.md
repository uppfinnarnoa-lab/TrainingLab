...
*Last updated: 2026-06-28b — Promoted Performance Trends to a top-level Stats tab, matched its page chrome to /stats/volume, and fixed vdotTrend's current-month point disagreeing with the live VDOT stat (missing racePBs argument in both cache.ts and stats/page.tsx).*
