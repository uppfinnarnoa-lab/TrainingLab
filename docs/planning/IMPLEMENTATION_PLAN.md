...
*Last updated: 2026-06-30c — Wrote [AI_COACH_AGENTIC_RELIABILITY_PLAN_2026_06_29.md](Planerattköra/AI_COACH_AGENTIC_RELIABILITY_PLAN_2026_06_29.md): root-caused leaked Kimi K2 tool-call tokens and "can't keep using tools" to NVIDIA/Groq/Gemini never getting a real multi-step tool loop, and traced "streams no longer fetch" to an unguarded nightly backfill cron job starving the on-demand fetch's Strava rate-limit budget.*
