...
export function MetricTooltip({ tip, className }: { tip: Tooltip; className?: string }) {
  ...
  return (
    <div className="relative inline-block">
      ...
      {open && (
        <div className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 w-72 rounded-xl bg-surface border border-border shadow-xl p-4 space-y-2 text-left pointer-events-none">
